...
// SHA-256 constants from FIPS 180-4. This small synchronous implementation is
// deliberately dependency-free so the public schedule barrel remains usable
// in browser/client graphs as well as on the server.
const INITIAL_HASH = [
...
function sha256(value: string): string {
  ...
  lengthView.setUint32(blockLength - 8, bitLengthHigh);
  lengthView.setUint32(blockLength - 4, bitLengthLow);
