...
import type { TemplatePartial } from '@prisma/client';
import type {
...
async function fetchAllPartials(tenantId?: string): Promise<{ partials: Pick<TemplatePartial, 'id' | 'name' | 'displayName' | 'description'>[] }> {
