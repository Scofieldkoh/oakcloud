 ...
 * damaged native metadata fails closed, and only legacy A4 drafts reach the
 * A4 editor.
 */
  ...
  useEffect(() => {
    ...
    void fetch(`/api/generated-documents/${encodeURIComponent(documentId)}`, { signal: controller.signal })
      .then(async (response) => {
        ...
        const document = payload as GeneratedDocument & { metadata?: unknown };
        setProbe({
