...
export const NekotaliaGermouser: CharacterConfig = {
  id: 'nekotalia-germouser',
  name: 'Germouser',
  series: 'Nekotalia',
  spritePath: '/pets/sprites/nekotalia-germouser/sprite.png',
  frameSize: 128,
  animations: {
    ...
    greet: { spriteLine: 4, frameMax: 8, frameRate: 8 },
