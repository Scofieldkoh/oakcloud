...
export const AnimeNezuko: CharacterConfig = {
  id: 'anime-nezuko',
  name: 'Nezuko',
  series: 'Demon Slayer',
  spritePath: '/pets/sprites/anime-nezuko/sprite.png',
  frameSize: 128,
  animations: {
    ...
    greet: { spriteLine: 4, frameMax: 13, frameRate: 10 },
    crawl: { spriteLine: 5, frameMax: 4, frameRate: 10 },
    climb: { spriteLine: 6, frameMax: 4, frameRate: 10 },
