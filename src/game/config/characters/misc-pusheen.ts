...
export const MiscPusheen: CharacterConfig = {
  id: 'misc-pusheen',
  name: 'Pusheen',
  series: 'Pusheen',
  spritePath: '/pets/sprites/misc-pusheen/sprite.png',
  frameSize: 128,
  animations: {
  ...
  credit: {
    resource: 'DeviantArt',
    link: 'https://www.deviantart.com/crystalclearcc/art/pusheen-shimeji-420686749',
  },
};
