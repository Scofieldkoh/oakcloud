...
export const DynastyYuanJi: CharacterConfig = {
  id: 'dynasty-yuan-ji',
  name: 'Yuan Ji',
  series: 'Dynasty Warriors',
  spritePath: '/pets/sprites/dynasty-yuan-ji/sprite.png',
  frameSize: 128,
  animations: {
    stand: { spriteLine: 1, frameMax: 1, frameRate: 8 },
    walk: { spriteLine: 2, frameMax: 3, frameRate: 10 },
    sit: { spriteLine: 3, frameMax: 1, frameRate: 6 },
    greet: { spriteLine: 4, frameMax: 1, frameRate: 8 },
    ...
    fall: { spriteLine: 6, frameMax: 4, frameRate: 10 },
