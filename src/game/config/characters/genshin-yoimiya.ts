...
export const GenshinYoimiya: CharacterConfig = {
  id: 'genshin-yoimiya',
  name: 'Yoimiya',
  series: 'Genshin Impact',
  spritePath: '/pets/sprites/genshin-yoimiya/sprite.png',
  frameSize: 128,
  animations: {
    stand: { spriteLine: 1, frameMax: 14, frameRate: 8 },
    walk: { spriteLine: 2, frameMax: 4, frameRate: 12 },
    sit: { spriteLine: 3, frameMax: 34, frameRate: 6 },
    greet: { spriteLine: 4, frameMax: 18, frameRate: 10 },
