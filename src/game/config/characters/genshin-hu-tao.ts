...
export const GenshinHuTao: CharacterConfig = {
  id: 'genshin-hu-tao',
  name: 'Hu Tao',
  series: 'Genshin Impact',
  spritePath: '/pets/sprites/genshin-hu-tao/sprite.png',
  frameSize: 128,
  animations: {
  ...
  credit: {
    ...
    link: 'https://twitter.com/uuteki_art/status/1396196381421867011',
  },
};
