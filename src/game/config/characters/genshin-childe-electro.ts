...
export const GenshinChildeElectro: CharacterConfig = {
  id: 'genshin-childe-electro',
  name: 'Childe (Electro)',
  series: 'Genshin Impact',
  spritePath: '/pets/sprites/genshin-childe-electro/sprite.png',
  frameSize: 128,
  animations: {
  ...
  credit: {
    ...
    link: 'https://drive.google.com/drive/folders/1sWs0nQlMJxkIh01qqvCbQF0AF1esdaZQ',
  },
};
