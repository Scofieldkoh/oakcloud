...
export const MiscSpongebob: CharacterConfig = {
  id: 'misc-spongebob',
  name: 'Spongebob',
  series: 'Spongebob Squarepants',
  spritePath: '/pets/sprites/misc-spongebob/sprite.png',
  frameSize: 128,
  animations: {
    stand: { spriteLine: 1, frameMax: 1, frameRate: 8 },
    walk: { spriteLine: 2, frameMax: 4, frameRate: 12 },
    sit: { spriteLine: 3, frameMax: 8, frameRate: 6 },
  ...
  credit: {
    resource: 'DeviantArt',
    link: 'https://www.deviantart.com/sojia/art/Spongebob-Shimeji-Mascot-317014699',
  },
};
