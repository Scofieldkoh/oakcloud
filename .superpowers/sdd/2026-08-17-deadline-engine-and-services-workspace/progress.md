...
| 14 | IMPLEMENTED / pending rereview | `pending` | Review corrections complete: focused admin suite 5 files/30 tests; Task3–8/10/catalog compatibility 16 files/137 tests; Chromium 2 tests; TypeScript/scoped zero-warning lint/diff green; evidence in `task-14-report.md` |
| 15 | pending | — | — |
