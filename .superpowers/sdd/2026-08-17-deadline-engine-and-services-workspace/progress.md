...
| 14 | IMPLEMENTED / pending review | `pending` | Focused admin suite 5 files/21 tests; Task3–8/10/catalog compatibility 16 files/128 tests; Chromium 2 tests; TypeScript/scoped zero-warning lint/diff green; evidence in `task-14-report.md` |
| 15 | pending | — | — |
