...
| 14 | IMPLEMENTED / pending final rereview | `pending` | Final rereview corrections complete: focused admin suite 5 files/32 tests; Task3–8/10/catalog compatibility 16 files/139 tests; Chromium 2 tests; TypeScript/scoped zero-warning lint/diff green; evidence in `task-14-report.md` |
| 15 | pending | — | — |
